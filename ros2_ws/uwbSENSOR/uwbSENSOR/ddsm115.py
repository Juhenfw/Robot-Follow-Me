...
class MotorControl:
	...
	def __init__(self, device="/dev/ttyUSB2"):
	...
	def TwoBytesTo16Int(self, high_byte: int, lo_byte: int):
		int16 = ((high_byte & 0xFF) << 8) | (lo_byte & 0xFF)  # Gabungkan dua byte
		if int16 > 32767:  # Jika lebih dari batas int16 positif, ubah ke nilai negatif
			int16 -= 65536
		return int16
