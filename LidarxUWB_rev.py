...
class UWBTracker:
    ...
    def __init__(self):  # ← Perubahan dari init ke __init__
...
class LidarProcessor:
    ...
    def __init__(self, port=LIDAR_PORT):  # ← Perubahan dari init ke __init__
        self.port = port
        self.lidar = None
...
class RobotController:
    ...
    def __init__(self, r_wheel_port, l_wheel_port):  # ← Perubahan dari init ke __init__
        # Motor controllers
...
if __name__ == "__main__":  # ← Perubahan dari if name == "__main__" ke if __name__ == "__main__"
